  ...
  <div class="table-classic-wrapper">
    ...
    <el-card shadow="always">
      ...
      <div class="control-btns">
        <el-button type="primary" @click="handleCreate">新建系列</el-button>
      ...
      <el-table ref="multipleTable" v-loading="listLoading" :data="tableData" tooltip-effect="dark" style="width: 100%"
        ...
        <el-table-column prop="categoryName" label="系列名称" align="left" width="200" sortable />

        <el-table-column label="系列描述" align="left">
...
import { saveCategory, queryCategoryList,deleteCategory } from "@/api/category";
  ...
  methods: {
    ...
    handleEdit(index, row) {
      ...
      for (const key in this.categoryForm) {
        this.categoryForm[key] = row[key]
      }
      console.log(index, row, this.categoryForm);
    },
    // 删除数据
    ...
    fetchData() {
      ...
      // 获取数据列表接口
      queryCategoryList(this.listQuery)
        .then((res) => {
          const data = res;
          if (res.code === 0) {
